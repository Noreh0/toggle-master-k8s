...
3.  **Configure as Variáveis de Ambiente:**
    ...
    DATABASE_URL="REPLACE_WITH_AUTH_DATABASE_URL"
    
    # Porta que o serviço irá rodar
    PORT="8001"
    
    # Chave mestra para criar novas chaves de API
    MASTER_KEY="REPLACE_WITH_MASTER_KEY"
    ```
...
-H "Authorization: Bearer REPLACE_WITH_MASTER_KEY" \
...
-H "Authorization: Bearer REPLACE_WITH_SERVICE_API_KEY"
```
